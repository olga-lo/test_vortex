...
def test_currency_conversion():
    with sync_playwright() as p:
        ...
        # 3. Найти селектор первой валюты и выбрать EUR
        ...
        # 4 Найти селектор второй валюты и выбрать AUD
        ...
        # 5. Найти кнопку конвертации и кликнуть
        button_converter = page.locator('[data-finance_media-desktop="convert_link"]')
        button_converter.click()

        # 6. Найти значение сконвертированного курса и вывести его
